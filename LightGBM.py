...
sales = pd.read_csv('sales_train.csv', parse_dates=['date'],dtype={'date': 'str', 'date_block_num': 'int32', 
                                                                    ...
                                                                    'item_cnt_day': 'int32'})
# data = pd.read_csv('data_preprocessing.csv',dtype={"shop_id":"int32","item_id":"int32","date_block_num":"int32","item_category_id":"int32",
#                                                   "item_price":"float64","item_price_mean":"float64","item_cnt_sum":"int32","item_cnt_mean":"float64",
#                                                   "item_cnt_month":"int32","revenue":"float64","item_price_unit":"int32","hist_min_item_price":"float64",
#                                                   "hist_max_item_price":"float64","price_increase":"float64","price_decrease":"float64",
#                                                   "avg_item_cnt_lag_4":"float64","item_avg_item_cnt_lag_4":"float64","shop_avg_item_cnt_lag_4":"float64",
#                                                   "year":"int32","month":"int32","days":"int32"})
